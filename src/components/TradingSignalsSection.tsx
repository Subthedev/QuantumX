...
export const TradingSignalsSection: React.FC<TradingSignalsProps> = ({ signal, marketData, reportGeneratedAt, coinSymbol = 'BTC' }) => {
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-background/60 rounded-lg border border-border">
                ...
                <div className="flex flex-col">
                  ...
                  <span className={`text-xs font-bold ${
                    ...
                    validityPercent > 25 ? 'text-blue-600' : 'text-red-600'
                  }`}>
                    {timeRemaining}
                  </span>
                </div>
          ...
          <>
                  ...
                  <div className="flex-1 bg-background/50 rounded-full h-2 overflow-hidden w-24">
                    <div 
                      className={`h-full rounded-full transition-all duration-500 ${
                        ...
                        signal.confidence >= 50 ? 'bg-blue-500' : 'bg-red-500'
                      }`}
            ...
            <div className="space-y-2">
              ...
              {signal.take_profits?.map((tp: number, i: number) => {
                ...
                return (
                  <div key={i} className="flex items-center gap-3 p-2.5 bg-green-500/5 rounded-lg border border-green-500/20">
