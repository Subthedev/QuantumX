...
import { 
  Loader2, TrendingUp, TrendingDown, Activity, DollarSign, BarChart3, 
  Clock, RefreshCw, CheckCircle, AlertTriangle, Timer, Shield, Target,
  Copy, Download, History, ChevronDown, ChevronUp, Keyboard, 
  FileText, Printer, ArrowUp, ArrowDown, Eye, EyeOff
} from "lucide-react";
...
interface AnalysisResult {
  ...
  riskMetrics?: {
    risk_reward_ratios: { tp1: number; tp2: number; tp3: number; };
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="flex gap-4 w-full md:w-auto">
                <Button
                  ...
                  className="flex-1 md:flex-initial btn-premium"
                >
                  {loading === 'BTC' ? (
                    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className={`card-premium ${analysisResult.validation?.passed ? 'border-green-500' : 'border-yellow-500'} border-2`}>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      <Badge className={`px-6 py-3 text-2xl font-bold ${
                        analysisResult.signal === 'LONG' ? 'bg-green-500' : 
                        analysisResult.signal === 'SHORT' ? 'bg-red-500' : 
                        'bg-orange-500'
                      }`}>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          {analysisResult.validation?.passed ? (
                    ...
                    <div className="text-right">
                      ...
                      {timeRemaining === 'EXPIRED' && (
                        <Badge variant="destructive" className="block mt-1">EXPIRED</Badge>
                      )}
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    {analysisResult.takeProfits?.map((tp, index) => (
              ...
              <Card className={`card-premium ${
                analysisResult.riskMetrics && analysisResult.riskMetrics.risk_reward_ratios.tp1 >= 2 
                  ? 'card-risk-low' 
                  : analysisResult.riskMetrics && analysisResult.riskMetrics.risk_reward_ratios.tp1 >= 1.5
                  ? 'card-risk-medium'
                  : 'card-risk-high'
              }`}>
                <CardHeader>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="space-y-1">
                        ...
                        <div className={`text-2xl font-bold ${
                          analysisResult.riskMetrics.risk_reward_ratios.tp1 >= 1.5 ? 'text-green-600' : 'text-yellow-600'
                        }`}>
              ...
              <Collapsible 
                ...
                onOpenChange={(open) => setExpandedSections({...expandedSections, technical: open})}
              >
                <Card className="card-premium">
...
${analysisResult.summary}`}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          toast({ title: "Technical data copied to clipboard" });
                        }}
                      >
            ...
            <div className="space-y-6">
              ...
              <Card className="card-premium">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Progress 
                    value={(signalHistory.filter(s => (s.profit || 0) > 0).length / signalHistory.length) * 100 || 0} 
                    className="h-2"
                  />
                </CardContent>
              </Card>
