        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="border rounded-lg p-3 bg-success/5 border-success/20">
            ...
            <div className="space-y-2">
              {supportLevels.map((level, idx) => <div key={idx} className="flex items-center justify-between">
          ...
          <div className="border rounded-lg p-3 bg-destructive/5 border-destructive/20">
            ...
            <div className="space-y-2">
              {resistanceLevels.map((level, idx) => <div key={idx} className="flex items-center justify-between">
        ...
        <div className="border rounded-lg p-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <div className={`text-sm font-semibold ${rsi > 70 ? 'text-destructive' : rsi < 30 ? 'text-success' : 'text-foreground'}`}>
                {Math.round(rsi)}
            ...
            <div>
              ...
              <div className={`text-sm font-semibold ${macd > 0 ? 'text-success' : 'text-destructive'}`}>
