-- ========================================
-- RESET ARENA AGENTS - Clear Fake Trades
-- ========================================
...
INSERT INTO mock_trading_accounts (user_id, balance, initial_balance, total_trades, total_pnl)
VALUES
  ('agent-nexus-01', 10000, 10000, 0, 0),
  ('agent-quantum-x', 10000, 10000, 0, 0),
  ('agent-zeonix', 10000, 10000, 0, 0)
